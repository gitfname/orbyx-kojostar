        ...
        <>
            {
                isLoading
                    ?
                    <div className="w-full h-screen fixed top-0 left-0 z-[9999999] bg-blue-600 flex flex-col gap-y-5 items-center justify-center">
                        <p className="text-xl text-white tracking-wide font-[vazir]">لطفا صبر کنید</p>
