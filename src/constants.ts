...
export const localStorage_token_key = "auth-token"
export const getHomeDataApiUrl = API_BASE_URL+getHomeDataApiEndPoint
export const searchApiUrl = API_BASE_URL+searchApiEndPoint
